...
namespace lssm {
	...
	void CommonCoreManager::startPresentation() {
		...
		LocalAgent::getInstance()->setTuner((ITuner*)tuner);
		ProgramRecorder::getInstance()->setTuner((ITuner*)tuner);
		ProgramRecorder::getInstance()->setDemuxer((IDemuxer*)demuxer);
		ProgramRecorder::getInstance()->setDataProcessor((IDataProcessor*)dataProcessor);
