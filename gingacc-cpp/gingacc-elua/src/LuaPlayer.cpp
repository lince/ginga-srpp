...
// Registra uma função C na pilha do LuaState.
void LuaPlayer::registerCGCFunctions(lua_State* L)
{
	lua_register(L, "lua_getExt", LuaCGCPlayer::lua_getExt);
	lua_register(L, "lua_completePath", LuaCGCPlayer::lua_completePath);
	lua_register(L, "lua_listRecords", LuaCGCPlayer::lua_listRecords);
	lua_register(L, "lua_getRecord", LuaCGCPlayer::lua_getRecord);
	lua_register(L, "lua_removeRecord", LuaCGCPlayer::lua_removeRecord);
}
...
void LuaPlayer::load ()
{
	...
	//registra a função teste no lua_state
	registerCGCFunctions(this->L);
